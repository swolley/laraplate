    ...
    >
        @foreach ($items as $item)
            @php
                ...
                // Upstream Filament clears item icons when the group has an icon
                // (collapsed rail uses group-icon dropdowns). We keep both so dense
                // modules (e.g. ERP) stay scannable in the expanded sidebar.
                // Re-check this override after filament/filament upgrades.
            @endphp
