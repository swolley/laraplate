...
'insights.remove','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ForbiddenPrivateMethods.title','insights.config.SlevomatCodingStandard\\Sniffs\\Complexity\\CognitiveSniff.title','insights.config.SlevomatCodingStandard\\Sniffs\\Complexity\\CognitiveSniff.warningThreshold','insights.config.SlevomatCodingStandard\\Sniffs\\Complexity\\CognitiveSniff.errorThreshold',
'insights.requirements.min-quality','insights.requirements.min-complexity','insights.requirements.min-architecture','insights.requirements.min-style','insights.requirements.disable-security-check',
...
'logging.channels.emergency.path','logging.channels.gelf.driver','logging.channels.gelf.level','logging.channels.gelf.via','logging.channels.gelf.host',
'logging.channels.gelf.port','logging.channels.gelf.processors','logging.channels.deprecations.driver','logging.channels.deprecations.handler','mail.default',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.slack.client_id','services.slack.client_secret','services.slack.redirect',
'services.geocoding.provider','services.geocoding.api_key','services.facebook.client_id','services.facebook.client_secret','services.facebook.redirect',
...
'broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','elastic.client.default',
'elastic.client.connections.default.hosts','elastic.client.connections.default.retries','elastic.client.connections.default.timeout','elastic.client.connections.default.connect_timeout','elastic.client.connections.default.ssl_verification',
'elastic.client.connections.default.username','elastic.client.connections.default.password','elastic.client.connections.default.log_enabled','elastic.client.connections.default.log_level','elastic.client.retry_on_conflict',
'elastic.client.bulk_size','elastic.scout_driver.refresh_documents','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class',
'blade-heroicons.attributes','blade-icons.sets','blade-icons.class','blade-icons.attributes','blade-icons.fallback',
'blade-icons.components.disabled','blade-icons.components.default','laravel-impersonate.session_key','laravel-impersonate.session_guard','laravel-impersonate.session_guard_using',
'laravel-impersonate.default_impersonator_guard','laravel-impersonate.take_redirect_to','laravel-impersonate.leave_redirect_to','fortify.guard','fortify.middleware',
...
'fortify.redirects.register','fortify.redirects.email-verification','fortify.redirects.password-reset','fortify.features','scout.driver',
...
'scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings','scout.vector_search.enabled','scout.vector_search.dimensions','scout.vector_search.provider',
'scout.queue_name','scout.queue_timeout','scout.queue_tries','scout.queue_backoff','livewire.class_namespace',
...
'livewire.inject_morph_markers','livewire.pagination_theme','versionable.keep_versions','versionable.user_foreign_key','versionable.version_model',
...
'permission.cache.store','permission.roles.superadmin','permission.roles.admin','permission.roles.guest','permission.users.superadmin',
'permission.users.admin','permission.users.guest','swagger-ui.files.0.path','swagger-ui.files.0.title','swagger-ui.files.0.versions.v1',
