...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.redis.options.read_timeout' => 'integer',
            'database.redis.options.retry_interval' => 'integer',
            'database.redis.options.timeout' => 'integer',
            ...
            'database.redis.default.read_timeout' => 'integer',
            ...
            'database.redis.queues.read_timeout' => 'integer',
            ...
            'database.redis.sessions.read_timeout' => 'integer',
            ...
            'database.redis.horizon.read_timeout' => 'integer',
            ...
            'filament.path' => 'string',
            'filament.domain' => 'NULL',
            'filament.home_url' => 'string',
            'filament.livewire.namespace' => 'string',
            'filament.livewire.path' => 'string',
            'filament.cache.enabled' => 'boolean',
            'filament.cache.store' => 'string',
            'filament.cache.prefix' => 'string',
            'filament.cache.ttl' => 'integer',
...
'database.redis.client','database.redis.options.cluster','database.redis.options.prefix','database.redis.options.persistent','database.redis.options.read_timeout',
'database.redis.options.retry_interval','database.redis.options.timeout','database.redis.default.url','database.redis.default.host','database.redis.default.username',
'database.redis.default.password','database.redis.default.port','database.redis.default.database','database.redis.default.read_timeout','database.redis.cache.url',
...
'database.redis.cache.prefix','database.redis.queues.url','database.redis.queues.host','database.redis.queues.username','database.redis.queues.password',
'database.redis.queues.port','database.redis.queues.database','database.redis.queues.prefix','database.redis.queues.read_timeout','database.redis.sessions.url',
...
'database.redis.sessions.prefix','database.redis.sessions.read_timeout','database.redis.horizon.url','database.redis.horizon.host','database.redis.horizon.username',
'database.redis.horizon.password','database.redis.horizon.port','database.redis.horizon.database','database.redis.horizon.read_timeout','database.redis.horizon.options.prefix',
...
'filament.system_route_prefix','filament.layout.sidebar.is_collapsible_on_desktop','filament.layout.sidebar.groups.are_collapsible','filament.layout.sidebar.width','filament.layout.footer.should_show_logo',
'filament.favicon','filament.auth.guard','filament.auth.pages.login','filament.pages.namespace','filament.pages.path',
'filament.pages.register','filament.resources.namespace','filament.resources.path','filament.resources.register','filament.widgets.namespace',
'filament.widgets.path','filament.widgets.register','filament.path','filament.domain','filament.home_url',
'filament.livewire.namespace','filament.livewire.path','filament.cache.enabled','filament.cache.store','filament.cache.prefix',
'filament.cache.ttl','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./srv/http/laraplate/public/storage','horizon.domain',
...
'horizon.memory_limit','horizon.defaults.supervisor-embeddings.connection','horizon.defaults.supervisor-embeddings.queue','horizon.defaults.supervisor-embeddings.balance','horizon.defaults.supervisor-embeddings.processes',
'horizon.defaults.supervisor-embeddings.tries','horizon.defaults.supervisor-indexing.connection','horizon.defaults.supervisor-indexing.queue','horizon.defaults.supervisor-indexing.balance','horizon.defaults.supervisor-indexing.processes',
'horizon.defaults.supervisor-indexing.tries','horizon.environments.production.supervisor-embeddings.timeout','horizon.environments.production.supervisor-embeddings.memory','horizon.environments.production.supervisor-embeddings.maxProcesses','horizon.environments.production.supervisor-embeddings.balanceMaxShift',
'horizon.environments.production.supervisor-embeddings.balanceCooldown','horizon.environments.production.supervisor-embeddings.nice','horizon.environments.production.supervisor-indexing.timeout','horizon.environments.production.supervisor-indexing.memory','horizon.environments.production.supervisor-indexing.maxProcesses',
'horizon.environments.production.supervisor-indexing.balanceMaxShift','horizon.environments.production.supervisor-indexing.balanceCooldown','horizon.environments.production.supervisor-indexing.nice','horizon.environments.local.supervisor-embeddings.processes','horizon.environments.local.supervisor-indexing.processes',
...
'ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','insights.preset',
'insights.ide','insights.exclude','insights.add.NunoMaduro\\PhpInsights\\Domain\\Metrics\\Architecture\\Classes','insights.remove','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ForbiddenPrivateMethods.title',
'insights.config.SlevomatCodingStandard\\Sniffs\\Complexity\\CognitiveSniff.title','insights.config.SlevomatCodingStandard\\Sniffs\\Complexity\\CognitiveSniff.warningThreshold','insights.config.SlevomatCodingStandard\\Sniffs\\Complexity\\CognitiveSniff.errorThreshold','insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Metrics\\CyclomaticComplexitySniff.title','insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Metrics\\CyclomaticComplexitySniff.warningThreshold',
'insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Metrics\\CyclomaticComplexitySniff.errorThreshold','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\CyclomaticComplexityIsHigh.title','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\CyclomaticComplexityIsHigh.maxComplexity','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\MethodCyclomaticComplexityIsHigh.title','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\MethodCyclomaticComplexityIsHigh.maxMethodComplexity',
'insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ClassMethodAverageCyclomaticComplexityIsHigh.title','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ClassMethodAverageCyclomaticComplexityIsHigh.maxClassMethodAverageComplexity','insights.requirements.min-quality','insights.requirements.min-complexity','insights.requirements.min-architecture',
'insights.requirements.min-style','insights.requirements.disable-security-check','insights.threads','insights.timeout','logging.default',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.gelf.driver','logging.channels.gelf.level',
'logging.channels.gelf.via','logging.channels.gelf.host','logging.channels.gelf.port','logging.channels.gelf.processors','logging.channels.deprecations.driver',
...
'services.ses.region','services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.slack.client_id',
'services.slack.client_secret','services.slack.redirect','services.geocoding.provider','services.geocoding.api_key','services.facebook.client_id',
'services.facebook.client_secret','services.facebook.redirect','services.x.client_id','services.x.client_secret','services.x.redirect',
'services.linkedin-openid.client_id','services.linkedin-openid.client_secret','services.linkedin-openid.redirect','services.google.client_id','services.google.client_secret',
'services.google.redirect','services.github.client_id','services.github.client_secret','services.github.redirect','services.gitlab.client_id',
...
'services.slack-openid.client_id','services.slack-openid.client_secret','services.slack-openid.redirect','session.driver','session.lifetime',
...
'hashing.rehash_on_login','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'broadcasting.connections.null.driver','elastic.client.default','elastic.client.connections.default.hosts','elastic.client.connections.default.retries','elastic.client.connections.default.timeout',
'elastic.client.connections.default.connect_timeout','elastic.client.connections.default.ssl_verification','elastic.client.connections.default.username','elastic.client.connections.default.password','elastic.client.connections.default.log_enabled',
'elastic.client.connections.default.log_level','elastic.client.retry_on_conflict','elastic.client.bulk_size','elastic.scout_driver.refresh_documents','blade-heroicons.prefix',
'blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes','blade-icons.sets','blade-icons.class',
'blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','laravel-impersonate.session_key',
...
'fortify.features','scout.driver','scout.prefix','scout.queue','scout.after_commit',
...
'scout.typesense.client-settings.healthcheck_interval_seconds','scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings','scout.vector_search.enabled',
'scout.vector_search.dimensions','scout.vector_search.provider','scout.queue_name','scout.queue_timeout','scout.queue_tries',
'scout.queue_backoff','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'livewire.navigate.show_progress_bar','livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','versionable.keep_versions',
'versionable.user_foreign_key','versionable.version_model','versionable.user_model','versionable.uuid','eloquent-sortable.order_column_name',
'eloquent-sortable.sort_when_creating','eloquent-sortable.ignore_timestamps','media-library.disk_name','media-library.max_file_size','media-library.queue_connection_name',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','permission.roles.superadmin','permission.roles.admin',
'permission.roles.guest','permission.users.superadmin','permission.users.admin','permission.users.guest','swagger-ui.files.0.path',
'swagger-ui.files.0.title','swagger-ui.files.0.versions.v1','swagger-ui.files.0.default','swagger-ui.files.0.middleware','swagger-ui.files.0.validator_url',
'swagger-ui.files.0.modify_file','swagger-ui.files.0.server_url','swagger-ui.files.0.oauth.token_path','swagger-ui.files.0.oauth.refresh_path','swagger-ui.files.0.oauth.authorization_path',
'swagger-ui.files.0.oauth.client_id','swagger-ui.files.0.oauth.client_secret','swagger-ui.files.0.stylesheet','laravel-swagger.title','laravel-swagger.description',
'laravel-swagger.appVersion','laravel-swagger.host','laravel-swagger.basePath','laravel-swagger.schemes','laravel-swagger.consumes',
'laravel-swagger.produces','laravel-swagger.ignoredMethods','laravel-swagger.parseDocBlock','laravel-swagger.parseSecurity','laravel-swagger.authFlow',
'laravel-swagger.ignoredRoutes','tinker.commands','tinker.alias','tinker.dont_alias',);
