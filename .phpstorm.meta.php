    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Illuminate\Cache\Repository' => \Modules\Core\Cache\Repository::class,
            ...
            'Illuminate\Contracts\Cache\Repository' => \Modules\Core\Cache\Repository::class,
            ...
            'Modules\Cms\Services\Contracts\IGeocodingService' => \Modules\Cms\Services\NominatimService::class,
            ...
            'cache.store' => \Modules\Core\Cache\Repository::class,
    ...
    override(\config(), map([
            ...
            'filament.layout.sidebar.is_collapsible_on_desktop' => 'boolean',
            'filament.layout.sidebar.groups.are_collapsible' => 'boolean',
            'filament.layout.sidebar.width' => 'string',
            'filament.layout.footer.should_show_logo' => 'boolean',
            'filament.favicon' => 'NULL',
            'filament.auth.guard' => 'string',
            'filament.auth.pages.login' => 'string',
            'filament.pages.namespace' => 'string',
            'filament.pages.path' => 'string',
            'filament.pages.register' => 'array',
            'filament.resources.namespace' => 'string',
            'filament.resources.path' => 'string',
            'filament.resources.register' => 'array',
            'filament.widgets.namespace' => 'string',
            'filament.widgets.path' => 'string',
            'filament.widgets.register' => 'array',
            ...
            'insights.config.SlevomatCodingStandard\Sniffs\Complexity\CognitiveSniff.title' => 'string',
            'insights.config.SlevomatCodingStandard\Sniffs\Complexity\CognitiveSniff.warningThreshold' => 'integer',
            'insights.config.SlevomatCodingStandard\Sniffs\Complexity\CognitiveSniff.errorThreshold' => 'integer',
            'insights.config.PHP_CodeSniffer\Standards\Generic\Sniffs\Metrics\CyclomaticComplexitySniff.title' => 'string',
            'insights.config.PHP_CodeSniffer\Standards\Generic\Sniffs\Metrics\CyclomaticComplexitySniff.warningThreshold' => 'integer',
            'insights.config.PHP_CodeSniffer\Standards\Generic\Sniffs\Metrics\CyclomaticComplexitySniff.errorThreshold' => 'integer',
            'insights.config.NunoMaduro\PhpInsights\Domain\Insights\CyclomaticComplexityIsHigh.title' => 'string',
            'insights.config.NunoMaduro\PhpInsights\Domain\Insights\CyclomaticComplexityIsHigh.maxComplexity' => 'integer',
            'insights.config.NunoMaduro\PhpInsights\Domain\Insights\MethodCyclomaticComplexityIsHigh.title' => 'string',
            'insights.config.NunoMaduro\PhpInsights\Domain\Insights\MethodCyclomaticComplexityIsHigh.maxMethodComplexity' => 'integer',
            'insights.config.NunoMaduro\PhpInsights\Domain\Insights\ClassMethodAverageCyclomaticComplexityIsHigh.title' => 'string',
            'insights.config.NunoMaduro\PhpInsights\Domain\Insights\ClassMethodAverageCyclomaticComplexityIsHigh.maxClassMethodAverageComplexity' => 'integer',
            'insights.requirements.min-quality' => 'integer',
            'insights.requirements.min-complexity' => 'integer',
            'insights.requirements.min-architecture' => 'integer',
            'insights.requirements.min-style' => 'integer',
            'insights.requirements.disable-security-check' => 'boolean',
...
'auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.socialite.enabled',
...
'auth.verify_new_user','auth.enable_user_registration','auth.enable_user_2fa','auth.enable_user_licenses','cache.default',
...
'cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.stores.sessions.driver','cache.stores.sessions.connection','cache.stores.sessions.lock_connection',
'cache.prefix','cache.duration.short','cache.duration.medium','cache.duration.long','cors.paths',
...
'database.redis.cache.database','database.redis.cache.prefix','database.redis.queues.url','database.redis.queues.host','database.redis.queues.username',
'database.redis.queues.password','database.redis.queues.port','database.redis.queues.database','database.redis.queues.prefix','database.redis.sessions.url',
'database.redis.sessions.host','database.redis.sessions.username','database.redis.sessions.password','database.redis.sessions.port','database.redis.sessions.database',
'database.redis.sessions.prefix','database.redis.horizon.url','database.redis.horizon.host','database.redis.horizon.username','database.redis.horizon.password',
'database.redis.horizon.port','database.redis.horizon.database','database.redis.horizon.options.prefix','filament.broadcasting','filament.default_filesystem_disk',
'filament.assets_path','filament.cache_path','filament.livewire_loading_delay','filament.system_route_prefix','filament.layout.sidebar.is_collapsible_on_desktop',
'filament.layout.sidebar.groups.are_collapsible','filament.layout.sidebar.width','filament.layout.footer.should_show_logo','filament.favicon','filament.auth.guard',
'filament.auth.pages.login','filament.pages.namespace','filament.pages.path','filament.pages.register','filament.resources.namespace',
'filament.resources.path','filament.resources.register','filament.widgets.namespace','filament.widgets.path','filament.widgets.register',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./srv/http/laraplate/public/storage','horizon.domain','horizon.path',
...
'horizon.defaults.supervisor-embeddings.connection','horizon.defaults.supervisor-embeddings.queue','horizon.defaults.supervisor-embeddings.balance','horizon.defaults.supervisor-embeddings.processes','horizon.defaults.supervisor-embeddings.tries',
'horizon.defaults.supervisor-indexing.connection','horizon.defaults.supervisor-indexing.queue','horizon.defaults.supervisor-indexing.balance','horizon.defaults.supervisor-indexing.processes','horizon.defaults.supervisor-indexing.tries',
'horizon.environments.production.supervisor-embeddings.timeout','horizon.environments.production.supervisor-embeddings.memory','horizon.environments.production.supervisor-embeddings.maxProcesses','horizon.environments.production.supervisor-embeddings.balanceMaxShift','horizon.environments.production.supervisor-embeddings.balanceCooldown',
'horizon.environments.production.supervisor-embeddings.nice','horizon.environments.production.supervisor-indexing.timeout','horizon.environments.production.supervisor-indexing.memory','horizon.environments.production.supervisor-indexing.maxProcesses','horizon.environments.production.supervisor-indexing.balanceMaxShift',
'horizon.environments.production.supervisor-indexing.balanceCooldown','horizon.environments.production.supervisor-indexing.nice','horizon.environments.local.supervisor-embeddings.processes','horizon.environments.local.supervisor-indexing.processes','ide-helper.filename',
...
'ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','insights.preset','insights.ide',
'insights.exclude','insights.add.NunoMaduro\\PhpInsights\\Domain\\Metrics\\Architecture\\Classes','insights.remove','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ForbiddenPrivateMethods.title','insights.config.SlevomatCodingStandard\\Sniffs\\Complexity\\CognitiveSniff.title',
'insights.config.SlevomatCodingStandard\\Sniffs\\Complexity\\CognitiveSniff.warningThreshold','insights.config.SlevomatCodingStandard\\Sniffs\\Complexity\\CognitiveSniff.errorThreshold','insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Metrics\\CyclomaticComplexitySniff.title','insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Metrics\\CyclomaticComplexitySniff.warningThreshold','insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Metrics\\CyclomaticComplexitySniff.errorThreshold',
'insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\CyclomaticComplexityIsHigh.title','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\CyclomaticComplexityIsHigh.maxComplexity','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\MethodCyclomaticComplexityIsHigh.title','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\MethodCyclomaticComplexityIsHigh.maxMethodComplexity','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ClassMethodAverageCyclomaticComplexityIsHigh.title',
'insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ClassMethodAverageCyclomaticComplexityIsHigh.maxClassMethodAverageComplexity','insights.requirements.min-quality','insights.requirements.min-complexity','insights.requirements.min-architecture','insights.requirements.min-style',
'insights.requirements.disable-security-check','insights.threads','insights.timeout','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.gelf.driver','logging.channels.gelf.level','logging.channels.gelf.via',
'logging.channels.gelf.host','logging.channels.gelf.port','logging.channels.gelf.processors','logging.channels.deprecations.driver','logging.channels.deprecations.handler',
...
'filament.admin.auth.logout','filament.admin.auth.profile','filament.admin.auth.email-verification.prompt','filament.admin.auth.email-verification.verify','filament.admin.pages.dashboard',
'filament.admin.resources.core.acls.index','filament.admin.resources.core.acls.create','filament.admin.resources.core.acls.edit','filament.admin.resources.core.cron-jobs.index','filament.admin.resources.core.cron-jobs.create',
'filament.admin.resources.core.cron-jobs.edit','filament.admin.resources.core.licenses.index','filament.admin.resources.core.licenses.create','filament.admin.resources.core.licenses.edit','filament.admin.resources.core.permissions.index',
'filament.admin.resources.core.permissions.create','filament.admin.resources.core.permissions.edit','filament.admin.resources.core.roles.index','filament.admin.resources.core.roles.create','filament.admin.resources.core.roles.edit',
'filament.admin.resources.core.settings.index','filament.admin.resources.core.settings.create','filament.admin.resources.core.settings.edit','filament.admin.resources.core.users.index','filament.admin.resources.core.users.create',
'filament.admin.resources.core.users.edit','login','login.store','logout','password.request',
...
'two-factor.recovery-codes','horizon.stats.index','horizon.workload.index','horizon.masters.index',
...
'swagger.index','swagger.oauth2-redirect','core.docs.swaggerDocs','cms.api.relation.contents',
'cms.locations.geocode','core.docs.welcome','core.docs.phpinfo','core.crud.list','core.crud.detail',
...
'MAIL_USERNAME','MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','ELASTICSEARCH_HOST',
'ELASTICSEARCH_PORT','OPENAI_API_KEY','ENABLE_USER_REGISTRATION','ENABLE_SOCIAL_LOGIN','ENABLE_USER_LICENSES',
'ENABLE_USER_2FA','VERIFY_NEW_USER','ENABLE_DYNAMIC_ENTITIES','ENABLE_DYNAMIC_GRIDUTILS','EXPOSE_CRUD_API',
'FORCE_HTTPS',);
