...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'insights.config.PHP_CodeSniffer\Standards\Generic\Sniffs\Metrics\CyclomaticComplexitySniff.maxComplexity' => 'integer',
...
'insights.remove','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ForbiddenPrivateMethods.title','insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Metrics\\CyclomaticComplexitySniff.maxComplexity','insights.requirements','insights.threads',
...
'logging.channels.gelf.driver','logging.channels.gelf.level','logging.channels.gelf.via','logging.channels.gelf.host','logging.channels.gelf.port',
'logging.channels.gelf.processors','logging.channels.deprecations.driver','logging.channels.deprecations.handler','mail.default','mail.mailers.smtp.transport',
...
'services.slack.notifications.channel','services.slack.client_id','services.slack.client_secret','services.slack.redirect','services.geocoding.provider',
'services.geocoding.api_key','services.facebook.client_id','services.facebook.client_secret','services.facebook.redirect','services.x.client_id',
'services.x.client_secret','services.x.redirect','services.linkedin-openid.client_id','services.linkedin-openid.client_secret','services.linkedin-openid.redirect',
...
'services.github.redirect','services.gitlab.client_id','services.gitlab.client_secret','services.gitlab.redirect','services.bitbucket.client_id',
'services.bitbucket.client_secret','services.bitbucket.redirect','services.slack-openid.client_id','services.slack-openid.client_secret','services.slack-openid.redirect',
...
'broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','elastic.client.default','elastic.client.connections.default.hosts',
'elastic.client.connections.default.retries','elastic.client.connections.default.timeout','elastic.client.connections.default.connect_timeout','elastic.client.connections.default.ssl_verification','elastic.client.connections.default.username',
'elastic.client.connections.default.password','elastic.client.connections.default.log_enabled','elastic.client.connections.default.log_level','elastic.client.retry_on_conflict','elastic.client.bulk_size',
'elastic.scout_driver.refresh_documents','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes',
'blade-icons.sets','blade-icons.class','blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled',
'blade-icons.components.default','laravel-impersonate.session_key','laravel-impersonate.session_guard','laravel-impersonate.session_guard_using','laravel-impersonate.default_impersonator_guard',
...
'fortify.redirects.email-verification','fortify.redirects.password-reset','fortify.features','scout.driver','scout.prefix',
...
'scout.typesense.model-settings','scout.vector_search.enabled','scout.vector_search.dimensions','scout.vector_search.provider','scout.queue_name',
'scout.queue_timeout','scout.queue_tries','scout.queue_backoff','livewire.class_namespace','livewire.view_path',
...
'livewire.pagination_theme','versionable.keep_versions','versionable.user_foreign_key','versionable.version_model','versionable.user_model',
'versionable.uuid','eloquent-sortable.order_column_name','eloquent-sortable.sort_when_creating','eloquent-sortable.ignore_timestamps','media-library.disk_name',
...
'permission.roles.superadmin','permission.roles.admin','permission.roles.guest','permission.users.superadmin','permission.users.admin',
'permission.users.guest','swagger-ui.files.0.path','swagger-ui.files.0.title','swagger-ui.files.0.versions.v1','swagger-ui.files.0.default',
'swagger-ui.files.0.middleware','swagger-ui.files.0.validator_url','swagger-ui.files.0.modify_file','swagger-ui.files.0.server_url','swagger-ui.files.0.oauth.token_path',
'swagger-ui.files.0.oauth.refresh_path','swagger-ui.files.0.oauth.authorization_path','swagger-ui.files.0.oauth.client_id','swagger-ui.files.0.oauth.client_secret','swagger-ui.files.0.stylesheet',
'laravel-swagger.title','laravel-swagger.description','laravel-swagger.appVersion','laravel-swagger.host','laravel-swagger.basePath',
'laravel-swagger.schemes','laravel-swagger.consumes','laravel-swagger.produces','laravel-swagger.ignoredMethods','laravel-swagger.parseDocBlock',
'laravel-swagger.parseSecurity','laravel-swagger.authFlow','laravel-swagger.ignoredRoutes','tinker.commands','tinker.alias',
'tinker.dont_alias',);
