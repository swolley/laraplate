...
'validation.uuid','validation.custom.attribute-name.rule-name','core::app.day.0','core::app.day.1','core::app.day.2',
...
'REDIS_USER','REDIS_PASSWORD','ELASTICSEARCH_HOST','ELASTICSEARCH_PORT','OPENAI_API_KEY',
'JWT_SECRET','ENABLE_USER_REGISTRATION','ENABLE_SOCIAL_LOGIN','ENABLE_USER_LICENSE','VERIFY_NEW_USER',
'ENABLE_DYNAMIC_ENTITIES','ENABLE_DYNAMIC_GRIDUTILS','EXPOSE_CRUD_API','FORCE_HTTPS','CMS_DEFAULT_PERSISTENCE',);
