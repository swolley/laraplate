...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.providers.ldap.enabled' => 'boolean',
            'auth.providers.ldap.sync_groups' => 'boolean',
            'auth.providers.ldap.group_mapping.LDAP_Admins' => 'string',
            'auth.providers.ldap.group_mapping.LDAP_Users' => 'string',
            ...
            'ldap.default' => 'string',
            'ldap.connections.default.hosts' => 'array',
            'ldap.connections.default.username' => 'string',
            'ldap.connections.default.password' => 'string',
            'ldap.connections.default.port' => 'integer',
            'ldap.connections.default.base_dn' => 'string',
            'ldap.connections.default.timeout' => 'integer',
            'ldap.connections.default.use_ssl' => 'boolean',
            'ldap.connections.default.use_tls' => 'boolean',
...
'auth.providers.users.model','auth.providers.ldap.enabled','auth.providers.ldap.sync_groups','auth.providers.ldap.group_mapping.LDAP_Admins','auth.providers.ldap.group_mapping.LDAP_Users',
...
'auth.verify_new_user','auth.enable_user_registration','auth.enable_user_login','cache.default','cache.stores.array.driver',
...
'cache.prefix','cache.duration.short','cache.duration.medium','cache.duration.long','database.default',
...
'database.redis.default.password','database.redis.default.port','database.redis.default.database','database.redis.sessions.url','database.redis.sessions.host',
'database.redis.sessions.username','database.redis.sessions.password','database.redis.sessions.port','database.redis.sessions.database','database.redis.cache.url',
...
'database.redis.horizon.database','database.redis.horizon.options.prefix','explorer.connection.host','explorer.connection.port','explorer.connection.scheme',
'explorer.default_index_settings','explorer.indexes','explorer.prune_old_aliases','explorer.logging','explorer.logger',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./srv/http/laraplate/public/storage','ide-helper.filename',
...
'ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','jwt.secret','jwt.keys.public',
...
'jwt.blacklist_grace_period','jwt.decrypt_cookies','jwt.providers.jwt','jwt.providers.auth','jwt.providers.storage',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.graylog.driver',
'logging.channels.graylog.level','logging.channels.graylog.via','logging.channels.graylog.host','logging.channels.graylog.port','logging.channels.graylog.formatter',
'logging.channels.graylog.processors.0.processor','logging.channels.deprecations.driver','logging.channels.deprecations.handler','mail.default','mail.mailers.smtp.transport',
...
'modules.stubs.files.scaffold/config','modules.stubs.files.composer','modules.stubs.replacements.routes/web','modules.stubs.replacements.routes/api','modules.stubs.replacements.json',
...
'services.slack.redirect','services.mailgun.domain','services.mailgun.secret','services.mailgun.endpoint','services.mailgun.scheme',
...
'permission.enable_wildcard_permission','permission.cache.expiration_time','permission.cache.key','permission.cache.store','swagger-ui.files.0.path',
...
'laravel-swagger.ignoredRoutes','ldap.default','ldap.connections.default.hosts','ldap.connections.default.username','ldap.connections.default.password',
'ldap.connections.default.port','ldap.connections.default.base_dn','ldap.connections.default.timeout','ldap.connections.default.use_ssl','ldap.connections.default.use_tls',
...
'ignition.executeSolution','ignition.updateConfig','swagger.index','swagger.oauth2-redirect','core.docs.swaggerDocs','cms.api.relation.contents','cms.locations.geocode','core.api.list','core.api.detail',
'core.api.tree','core.api.search','core.api.history','core.api.insert','core.api.replace',
'core.api.delete','core.docs.welcome','core.docs.phpinfo','core.crud.list','core.crud.detail',
...
'core::components.module','core::components.php-icon','core::components.route-icon','core::components.swagger-icon','core::phpinfo',
...
'validation.uuid','validation.custom.attribute-name.rule-name','ldap::errors.user_not_found','ldap::errors.user_not_permitted_at_this_time','ldap::errors.user_not_permitted_to_login',
'ldap::errors.password_expired','ldap::errors.account_disabled','ldap::errors.account_expired','ldap::errors.user_must_reset_password','ldap::errors.user_account_locked',
...
'SESSION_EXPIRE_ON_CLOSE','QUEUE_CONNECTION','CACHE_STORE','REDIS_HOST','REDIS_USERNAME',
'REDIS_PASSWORD','ELASTICSEARCH_HOST','ELASTICSEARCH_PORT','OPENAI_API_KEY','JWT_SECRET',
'ENABLE_USER_REGISTRATION','ENABLE_SOCIAL_LOGIN','ENABLE_USER_LICENSE','VERIFY_NEW_USER','ENABLE_DYNAMIC_ENTITIES',
'ENABLE_DYNAMIC_GRIDUTILS','EXPOSE_CRUD_API','FORCE_HTTPS','CMS_DEFAULT_PERSISTENCE',);
