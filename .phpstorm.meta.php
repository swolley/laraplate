...
'auth.providers.ldap.enabled','auth.providers.ldap.sync_groups','auth.providers.ldap.group_mapping.LDAP_Admins','auth.providers.ldap.group_mapping.LDAP_Users','auth.passwords.users.provider',
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth.verify_new_user',
'auth.enable_user_registration','auth.enable_user_2fa','auth.enable_user_login','cache.default','cache.stores.array.driver',
...
'cache.stores.octane.driver','cache.prefix','cache.duration.short','cache.duration.medium','cache.duration.long',
...
'database.migrations.update_date_on_publish','database.redis.client','database.redis.options.cluster','database.redis.options.persistent','database.redis.default.url',
...
'filament.assets_path','filament.cache_path','filament.livewire_loading_delay','filament.system_route_prefix','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links./srv/http/laraplate/public/storage','horizon.domain','horizon.path','horizon.use',
...
'horizon.metrics.trim_snapshots.job','horizon.metrics.trim_snapshots.queue','horizon.fast_termination','horizon.memory_limit','horizon.defaults.supervisor-embeddings.connection',
'horizon.defaults.supervisor-embeddings.queue','horizon.defaults.supervisor-embeddings.balance','horizon.defaults.supervisor-embeddings.processes','horizon.defaults.supervisor-embeddings.tries','horizon.defaults.supervisor-indexing.connection',
'horizon.defaults.supervisor-indexing.queue','horizon.defaults.supervisor-indexing.balance','horizon.defaults.supervisor-indexing.processes','horizon.defaults.supervisor-indexing.tries','horizon.environments.production.supervisor-embeddings.timeout',
...
'horizon.environments.production.supervisor-indexing.nice','horizon.environments.local.supervisor-embeddings.processes','horizon.environments.local.supervisor-indexing.processes','ide-helper.filename','ide-helper.models_filename',
...
'logging.channels.emergency.path','logging.channels.graylog.driver','logging.channels.graylog.level','logging.channels.graylog.via','logging.channels.graylog.host',
'logging.channels.graylog.port','logging.channels.graylog.formatter','logging.channels.graylog.processors.0.processor','mail.default','mail.mailers.smtp.transport',
...
'laravel-swagger.parseSecurity','laravel-swagger.authFlow','laravel-swagger.ignoredRoutes','ldap.default','ldap.connections.default.hosts',
'ldap.connections.default.username','ldap.connections.default.password','ldap.connections.default.port','ldap.connections.default.base_dn','ldap.connections.default.timeout',
'ldap.connections.default.use_ssl','ldap.connections.default.use_tls','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'filament.admin.resources.cms.authors.index','filament.admin.resources.cms.authors.create','filament.admin.resources.cms.authors.edit','filament.admin.resources.core.users.index','filament.admin.resources.core.users.create',
...
'cms.locations.geocode','core.api.list','core.api.detail','core.api.tree','core.api.search',
'core.api.history','core.api.insert','core.api.replace','core.api.delete','core.docs.welcome',
'core.docs.phpinfo','core.crud.list','core.crud.detail','core.crud.tree','core.crud.search',
'core.crud.history','core.crud.insert','core.crud.replace','core.crud.delete','core.crud.lock',
'core.crud.unlock','core.crud.approve','core.crud.disapprove','core.crud.activate','core.crud.inactivate',
'core.crud.cache-clear','core.crud.grids.getGridsConfigs','core.crud.select','core.crud.data','core.crud.check',
'core.crud.layout','core.crud.export','core.crud.insert','core.crud.replace','core.crud.delete',
'core.auth.userInfo','core.auth.impersonate','core.auth.leaveImpersonate','core.auth.maintainSession','core.info.siteInfo',
'core.info.getSiteConfigs','core.info.translations','password.reset','storage.local',);
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','ldap::errors.user_not_found','ldap::errors.user_not_permitted_at_this_time',
'ldap::errors.user_not_permitted_to_login','ldap::errors.password_expired','ldap::errors.account_disabled','ldap::errors.account_expired','ldap::errors.user_must_reset_password',
'ldap::errors.user_account_locked','filament-actions::associate.single.label','filament-actions::associate.single.modal.heading','filament-actions::associate.single.modal.fields.record_id.label','filament-actions::associate.single.modal.actions.associate.label',
...
'filament-tables::table.sorting.fields.direction.options.asc','filament-tables::table.sorting.fields.direction.options.desc','core::app.day.0','core::app.day.1','core::app.day.2',
'core::app.day.3','core::app.day.4','core::app.day.5','core::app.day.6','core::app.day.Friday',
'core::app.day.Monday','core::app.day.Saturday','core::app.day.Sunday','core::app.day.Thursday','core::app.day.Tuesday',
'core::app.day.Wednesday','core::app.form.backward','core::app.form.characters','core::app.form.complete','core::app.form.confirmDelete',
'core::app.form.confirmSaveChange','core::app.form.delete','core::app.form.deleteRecord','core::app.form.editRecord','core::app.form.forward',
'core::app.form.insert','core::app.form.insertNewRecord','core::app.form.multipleFieldAdditionalInfo','core::app.form.multipleFieldPlaceholder','core::app.form.repeat',
'core::app.form.required','core::app.form.save','core::app.form.search','core::app.form.send','core::app.form.status.200',
'core::app.form.status.201','core::app.form.validation.0','core::app.form.validation.10','core::app.form.validation.20','core::app.form.validation.40',
'core::app.form.validation.50','core::app.form.validation.60','core::app.form.validation.70','core::app.form.validation.80','core::app.form.validation.90',
'core::app.form.validation.100','core::app.form.validation.110','core::app.form.validation.hasFiles','core::app.form.validation.requiresCaptions','core::app.form.validation.requiresMandatory',
'core::app.form.words','core::app.language','core::app.locale','core::app.login.cannotAccess','core::app.login.enter',
'core::app.login.goToAppLogin','core::app.login.hidePassword','core::app.login.password','core::app.login.rememberMe','core::app.login.restorePassword',
'core::app.login.returnToLogin','core::app.login.showPassword','core::app.login.user','core::app.menu.dashboard','core::app.menu.groups',
'core::app.menu.reports','core::app.menu.settings','core::app.menu.systemInfo','core::app.menu.users','core::app.month.1',
'core::app.month.2','core::app.month.3','core::app.month.4','core::app.month.5','core::app.month.6',
'core::app.month.7','core::app.month.8','core::app.month.9','core::app.month.10','core::app.month.11',
'core::app.month.12','core::app.month.April','core::app.month.August','core::app.month.December','core::app.month.February',
'core::app.month.January','core::app.month.July','core::app.month.June','core::app.month.March','core::app.month.May',
'core::app.month.November','core::app.month.October','core::app.month.September','core::app.setting.changePassword','core::app.setting.layout',
'core::app.setting.mainFontSize','core::app.setting.newPassword','core::app.setting.oldPassword','core::app.setting.passwordChanged','core::app.setting.preferences',
'core::app.setting.preferredLanguage','core::app.setting.settingsChanged','core::app.tables.buttons.actions','core::app.tables.buttons.clearAll','core::app.tables.buttons.columns',
'core::app.tables.buttons.delete','core::app.tables.buttons.enableComplexFilters','core::app.tables.buttons.export','core::app.tables.buttons.filters','core::app.tables.buttons.groups',
'core::app.tables.buttons.insert','core::app.tables.buttons.month','core::app.tables.buttons.orders','core::app.tables.buttons.reload','core::app.tables.buttons.reset',
'core::app.tables.buttons.restart','core::app.tables.buttons.retry','core::app.tables.buttons.search','core::app.tables.buttons.update','core::app.tables.buttons.year',
'core::app.tables.columns.code','core::app.tables.columns.createdAt','core::app.tables.columns.createdBy','core::app.tables.columns.date','core::app.tables.columns.deletedAt',
'core::app.tables.columns.deletedBy','core::app.tables.columns.group','core::app.tables.columns.id','core::app.tables.columns.name','core::app.tables.columns.updatedAt',
'core::app.tables.columns.updatedBy','core::app.tables.columns.user','core::app.tables.columns.validFrom','core::app.tables.columns.validTo','core::app.tables.filters.contains',
'core::app.tables.filters.equal','core::app.tables.filters.false','core::app.tables.filters.notEqual','core::app.tables.filters.true','core::app.tables.filters.values',
'core::auth.failed','core::auth.password','core::auth.throttle','core::pagination.all','core::pagination.next',
'core::pagination.previous','core::pagination.rowsForPage','core::pagination.rowsOf','core::pagination.selected','core::passwords.reset',
'core::passwords.sent','core::passwords.throttled','core::passwords.token','core::passwords.user','core::validation.accepted',
'core::validation.accepted_if','core::validation.active_url','core::validation.after','core::validation.after_or_equal','core::validation.alpha',
'core::validation.alpha_dash','core::validation.alpha_num','core::validation.array','core::validation.ascii','core::validation.attached',
'core::validation.before','core::validation.before_or_equal','core::validation.between.array','core::validation.between.file','core::validation.between.numeric',
'core::validation.between.string','core::validation.boolean','core::validation.can','core::validation.confirmed','core::validation.current_password',
'core::validation.custom.attribute-name.rule-name','core::validation.date','core::validation.date_equals','core::validation.date_format','core::validation.decimal',
'core::validation.declined','core::validation.declined_if','core::validation.different','core::validation.digits','core::validation.digits_between',
'core::validation.dimensions','core::validation.distinct','core::validation.doesnt_end_with','core::validation.doesnt_start_with','core::validation.email',
'core::validation.ends_with','core::validation.enum','core::validation.exists','core::validation.extensions','core::validation.file',
'core::validation.filled','core::validation.gt.array','core::validation.gt.file','core::validation.gt.numeric','core::validation.gt.string',
'core::validation.gte.array','core::validation.gte.file','core::validation.gte.numeric','core::validation.gte.string','core::validation.hex_color',
'core::validation.image','core::validation.in','core::validation.in_array','core::validation.integer','core::validation.ip',
'core::validation.ipv4','core::validation.ipv6','core::validation.json','core::validation.lowercase','core::validation.lt.array',
'core::validation.lt.file','core::validation.lt.numeric','core::validation.lt.string','core::validation.lte.array','core::validation.lte.file',
'core::validation.lte.numeric','core::validation.lte.string','core::validation.mac_address','core::validation.max.array','core::validation.max.file',
'core::validation.max.numeric','core::validation.max.string','core::validation.max_digits','core::validation.mimes','core::validation.mimetypes',
'core::validation.min.array','core::validation.min.file','core::validation.min.numeric','core::validation.min.string','core::validation.min_digits',
'core::validation.missing','core::validation.missing_if','core::validation.missing_unless','core::validation.missing_with','core::validation.missing_with_all',
'core::validation.multiple_of','core::validation.next','core::validation.not_in','core::validation.not_regex','core::validation.numeric',
'core::validation.password.letters','core::validation.password.mixed','core::validation.password.numbers','core::validation.password.symbols','core::validation.password.uncompromised',
'core::validation.present','core::validation.present_if','core::validation.present_unless','core::validation.present_with','core::validation.present_with_all',
'core::validation.previous','core::validation.prohibited','core::validation.prohibited_if','core::validation.prohibited_unless','core::validation.prohibits',
'core::validation.regex','core::validation.relatable','core::validation.required','core::validation.required_array_keys','core::validation.required_if',
'core::validation.required_if_accepted','core::validation.required_unless','core::validation.required_with','core::validation.required_with_all','core::validation.required_without',
'core::validation.required_without_all','core::validation.same','core::validation.size.array','core::validation.size.file','core::validation.size.numeric',
'core::validation.size.string','core::validation.starts_with','core::validation.string','core::validation.timezone','core::validation.ulid',
'core::validation.unique','core::validation.uploaded','core::validation.uppercase','core::validation.url','core::validation.uuid',);
...
'ENABLE_SOCIAL_LOGIN','ENABLE_USER_LICENSE','ENABLE_USER_2FA','VERIFY_NEW_USER','ENABLE_DYNAMIC_ENTITIES',
'ENABLE_DYNAMIC_GRIDUTILS','EXPOSE_CRUD_API','FORCE_HTTPS','SOFT_DELETES_EXPIRATION_DAYS',);
