...
'auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.ldap.enabled',
'auth.providers.ldap.sync_groups','auth.providers.ldap.group_mapping.LDAP_Admins','auth.providers.ldap.group_mapping.LDAP_Users','auth.passwords.users.provider','auth.passwords.users.table',
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth.verify_new_user','auth.enable_user_registration',
'auth.enable_user_2fa','auth.enable_user_login','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'horizon.defaults.supervisor-1.memory','horizon.defaults.supervisor-1.tries','horizon.defaults.supervisor-1.timeout','horizon.defaults.supervisor-1.nice','horizon.defaults.supervisor-embeddings.connection',
...
'horizon.defaults.supervisor-indexing.queue','horizon.defaults.supervisor-indexing.balance','horizon.defaults.supervisor-indexing.processes','horizon.defaults.supervisor-indexing.tries','horizon.environments.production.supervisor-1.maxProcesses',
'horizon.environments.production.supervisor-1.balanceMaxShift','horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.production.supervisor-embeddings.timeout','horizon.environments.production.supervisor-embeddings.memory','horizon.environments.production.supervisor-embeddings.maxProcesses',
'horizon.environments.production.supervisor-embeddings.balanceMaxShift','horizon.environments.production.supervisor-embeddings.balanceCooldown','horizon.environments.production.supervisor-embeddings.nice','horizon.environments.production.supervisor-indexing.timeout','horizon.environments.production.supervisor-indexing.memory',
'horizon.environments.production.supervisor-indexing.maxProcesses','horizon.environments.production.supervisor-indexing.balanceMaxShift','horizon.environments.production.supervisor-indexing.balanceCooldown','horizon.environments.production.supervisor-indexing.nice','horizon.environments.local.supervisor-1.maxProcesses',
...
'logging.channels.graylog.driver','logging.channels.graylog.level','logging.channels.graylog.via','logging.channels.graylog.host','logging.channels.graylog.port',
'logging.channels.graylog.formatter','logging.channels.graylog.processors.0.processor','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'services.slack.client_id','services.slack.client_secret','services.slack.redirect','services.geocoding.provider','services.geocoding.api_key',
'services.facebook.client_id','services.facebook.client_secret','services.facebook.redirect','services.x.client_id','services.x.client_secret',
'services.x.redirect','services.linkedin-openid.client_id','services.linkedin-openid.client_secret','services.linkedin-openid.redirect','services.google.client_id',
...
'services.bitbucket.redirect','services.slack-openid.client_id','services.slack-openid.client_secret','services.slack-openid.redirect','session.driver',
...
'broadcasting.connections.log.driver','broadcasting.connections.null.driver','laravel-impersonate.session_key','laravel-impersonate.session_guard','laravel-impersonate.session_guard_using',
...
'fortify.redirects.register','fortify.redirects.email-verification','fortify.redirects.password-reset','fortify.features','octane.server',
...
'swagger-ui.files.0.path','swagger-ui.files.0.title','swagger-ui.files.0.versions.v1','swagger-ui.files.0.default','swagger-ui.files.0.middleware',
'swagger-ui.files.0.validator_url','swagger-ui.files.0.modify_file','swagger-ui.files.0.server_url','swagger-ui.files.0.oauth.token_path','swagger-ui.files.0.oauth.refresh_path',
'swagger-ui.files.0.oauth.authorization_path','swagger-ui.files.0.oauth.client_id','swagger-ui.files.0.oauth.client_secret','swagger-ui.files.0.stylesheet','laravel-swagger.title',
'laravel-swagger.description','laravel-swagger.appVersion','laravel-swagger.host','laravel-swagger.basePath','laravel-swagger.schemes',
'laravel-swagger.consumes','laravel-swagger.produces','laravel-swagger.ignoredMethods','laravel-swagger.parseDocBlock','laravel-swagger.parseSecurity',
'laravel-swagger.authFlow','laravel-swagger.ignoredRoutes','ldap.default','ldap.connections.default.hosts','ldap.connections.default.username',
'ldap.connections.default.password','ldap.connections.default.port','ldap.connections.default.base_dn','ldap.connections.default.timeout','ldap.connections.default.use_ssl',
'ldap.connections.default.use_tls','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','swagger.index',
'swagger.oauth2-redirect','core.docs.swaggerDocs','cms.api.relation.contents','cms.locations.geocode',
'core.api.list','core.api.detail','core.api.tree','core.api.search','core.api.history',
'core.api.insert','core.api.replace','core.api.delete','core.docs.welcome','core.docs.phpinfo',
...
'core::components.swagger-icon','core::phpinfo','core::welcome','welcome','horizon::layout',
...
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','swagger-ui::index',);
...
'ldap::errors.user_account_locked','core::app.day.0','core::app.day.1','core::app.day.2','core::app.day.3',
'core::app.day.4','core::app.day.5','core::app.day.6','core::app.day.Friday','core::app.day.Monday',
'core::app.day.Saturday','core::app.day.Sunday','core::app.day.Thursday','core::app.day.Tuesday','core::app.day.Wednesday',
'core::app.form.backward','core::app.form.characters','core::app.form.complete','core::app.form.confirmDelete','core::app.form.confirmSaveChange',
'core::app.form.delete','core::app.form.deleteRecord','core::app.form.editRecord','core::app.form.forward','core::app.form.insert',
'core::app.form.insertNewRecord','core::app.form.multipleFieldAdditionalInfo','core::app.form.multipleFieldPlaceholder','core::app.form.repeat','core::app.form.required',
'core::app.form.save','core::app.form.search','core::app.form.send','core::app.form.status.200','core::app.form.status.201',
'core::app.form.validation.0','core::app.form.validation.10','core::app.form.validation.20','core::app.form.validation.40','core::app.form.validation.50',
'core::app.form.validation.60','core::app.form.validation.70','core::app.form.validation.80','core::app.form.validation.90','core::app.form.validation.100',
'core::app.form.validation.110','core::app.form.validation.hasFiles','core::app.form.validation.requiresCaptions','core::app.form.validation.requiresMandatory','core::app.form.words',
'core::app.language','core::app.locale','core::app.login.cannotAccess','core::app.login.enter','core::app.login.goToAppLogin',
'core::app.login.hidePassword','core::app.login.password','core::app.login.rememberMe','core::app.login.restorePassword','core::app.login.returnToLogin',
'core::app.login.showPassword','core::app.login.user','core::app.menu.dashboard','core::app.menu.groups','core::app.menu.reports',
'core::app.menu.settings','core::app.menu.systemInfo','core::app.menu.users','core::app.month.1','core::app.month.2',
'core::app.month.3','core::app.month.4','core::app.month.5','core::app.month.6','core::app.month.7',
'core::app.month.8','core::app.month.9','core::app.month.10','core::app.month.11','core::app.month.12',
'core::app.month.April','core::app.month.August','core::app.month.December','core::app.month.February','core::app.month.January',
'core::app.month.July','core::app.month.June','core::app.month.March','core::app.month.May','core::app.month.November',
'core::app.month.October','core::app.month.September','core::app.setting.changePassword','core::app.setting.layout','core::app.setting.mainFontSize',
'core::app.setting.newPassword','core::app.setting.oldPassword','core::app.setting.passwordChanged','core::app.setting.preferences','core::app.setting.preferredLanguage',
'core::app.setting.settingsChanged','core::app.tables.buttons.actions','core::app.tables.buttons.clearAll','core::app.tables.buttons.columns','core::app.tables.buttons.delete',
'core::app.tables.buttons.enableComplexFilters','core::app.tables.buttons.export','core::app.tables.buttons.filters','core::app.tables.buttons.groups','core::app.tables.buttons.insert',
'core::app.tables.buttons.month','core::app.tables.buttons.orders','core::app.tables.buttons.reload','core::app.tables.buttons.reset','core::app.tables.buttons.restart',
'core::app.tables.buttons.retry','core::app.tables.buttons.search','core::app.tables.buttons.update','core::app.tables.buttons.year','core::app.tables.columns.code',
'core::app.tables.columns.createdAt','core::app.tables.columns.createdBy','core::app.tables.columns.date','core::app.tables.columns.deletedAt','core::app.tables.columns.deletedBy',
'core::app.tables.columns.group','core::app.tables.columns.id','core::app.tables.columns.name','core::app.tables.columns.updatedAt','core::app.tables.columns.updatedBy',
'core::app.tables.columns.user','core::app.tables.columns.validFrom','core::app.tables.columns.validTo','core::app.tables.filters.contains','core::app.tables.filters.equal',
'core::app.tables.filters.false','core::app.tables.filters.notEqual','core::app.tables.filters.true','core::app.tables.filters.values','core::auth.failed',
'core::auth.password','core::auth.throttle','core::pagination.all','core::pagination.next','core::pagination.previous',
'core::pagination.rowsForPage','core::pagination.rowsOf','core::pagination.selected','core::passwords.reset','core::passwords.sent',
'core::passwords.throttled','core::passwords.token','core::passwords.user','core::validation.accepted','core::validation.accepted_if',
'core::validation.active_url','core::validation.after','core::validation.after_or_equal','core::validation.alpha','core::validation.alpha_dash',
'core::validation.alpha_num','core::validation.array','core::validation.ascii','core::validation.attached','core::validation.before',
'core::validation.before_or_equal','core::validation.between.array','core::validation.between.file','core::validation.between.numeric','core::validation.between.string',
'core::validation.boolean','core::validation.can','core::validation.confirmed','core::validation.current_password','core::validation.custom.attribute-name.rule-name',
'core::validation.date','core::validation.date_equals','core::validation.date_format','core::validation.decimal','core::validation.declined',
'core::validation.declined_if','core::validation.different','core::validation.digits','core::validation.digits_between','core::validation.dimensions',
'core::validation.distinct','core::validation.doesnt_end_with','core::validation.doesnt_start_with','core::validation.email','core::validation.ends_with',
'core::validation.enum','core::validation.exists','core::validation.extensions','core::validation.file','core::validation.filled',
'core::validation.gt.array','core::validation.gt.file','core::validation.gt.numeric','core::validation.gt.string','core::validation.gte.array',
'core::validation.gte.file','core::validation.gte.numeric','core::validation.gte.string','core::validation.hex_color','core::validation.image',
'core::validation.in','core::validation.in_array','core::validation.integer','core::validation.ip','core::validation.ipv4',
'core::validation.ipv6','core::validation.json','core::validation.lowercase','core::validation.lt.array','core::validation.lt.file',
'core::validation.lt.numeric','core::validation.lt.string','core::validation.lte.array','core::validation.lte.file','core::validation.lte.numeric',
'core::validation.lte.string','core::validation.mac_address','core::validation.max.array','core::validation.max.file','core::validation.max.numeric',
'core::validation.max.string','core::validation.max_digits','core::validation.mimes','core::validation.mimetypes','core::validation.min.array',
'core::validation.min.file','core::validation.min.numeric','core::validation.min.string','core::validation.min_digits','core::validation.missing',
'core::validation.missing_if','core::validation.missing_unless','core::validation.missing_with','core::validation.missing_with_all','core::validation.multiple_of',
'core::validation.next','core::validation.not_in','core::validation.not_regex','core::validation.numeric','core::validation.password.letters',
'core::validation.password.mixed','core::validation.password.numbers','core::validation.password.symbols','core::validation.password.uncompromised','core::validation.present',
'core::validation.present_if','core::validation.present_unless','core::validation.present_with','core::validation.present_with_all','core::validation.previous',
'core::validation.prohibited','core::validation.prohibited_if','core::validation.prohibited_unless','core::validation.prohibits','core::validation.regex',
'core::validation.relatable','core::validation.required','core::validation.required_array_keys','core::validation.required_if','core::validation.required_if_accepted',
'core::validation.required_unless','core::validation.required_with','core::validation.required_with_all','core::validation.required_without','core::validation.required_without_all',
'core::validation.same','core::validation.size.array','core::validation.size.file','core::validation.size.numeric','core::validation.size.string',
'core::validation.starts_with','core::validation.string','core::validation.timezone','core::validation.ulid','core::validation.unique',
'core::validation.uploaded','core::validation.uppercase','core::validation.url','core::validation.uuid',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_PORT','FRONTEND_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
'APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK',
'LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','LOG_DAILY_DAYS','DB_CONNECTION','DB_HOST',
...
'REDIS_HOST','REDIS_USERNAME','REDIS_PASSWORD','REDIS_PORT','ELASTICSEARCH_HOST',
'ELASTICSEARCH_PORT','OPENAI_API_KEY','ENABLE_USER_REGISTRATION','ENABLE_SOCIAL_LOGIN','ENABLE_USER_LICENSE',
'ENABLE_USER_2FA','VERIFY_NEW_USER','ENABLE_DYNAMIC_ENTITIES','ENABLE_DYNAMIC_GRIDUTILS','EXPOSE_CRUD_API',
'FORCE_HTTPS','SOFT_DELETES_EXPIRATION_DAYS',);
