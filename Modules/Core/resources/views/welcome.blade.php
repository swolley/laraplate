        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#a5ac56] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex justify-center lg:col-start-2 h-12 w-auto lg:h-16 text-[#a5ac56] gap-2">
                        <svg class="h-12 w-auto lg:h-16 text-[#a5ac56]" viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg">
