...
todos:
  ...
  - id: bank-reconciliation
    content: "M6.1 — **Riconciliazione Bancaria.** V1 implementata come import CSV, conti/estratti/righe banca, match manuale, suggerimenti automatici per importo/data/reference e UI Filament minimale. Il sotto-flusso professionale delle differenze è presente: commissioni, arrotondamenti e scarti possono generare journal entry tramite conto banca con ruolo `bank_cash`, conto expense selezionato in UI e FK audit `difference_journal_entry_id` sulla riga estratto. CAMT.053/MT940 restano fuori scope iniziale e sono backlog Phase 2B. Test: import CSV, match manuale, suggerimenti compatibili, journal differenze e match con differenza."
    status: completed
...
| `bank-reconciliation` | M6.1 | Import estratti conto, riconciliazione bancaria v1, journal differenze e match con differenza; CAMT.053/MT940 come follow-up | IMPORTANTE |
