...
| `einvoice-sdi-binding` | M6.3 / Phase 2C | Stub `EInvoiceProvider`, submission e azioni UI completati; FatturaPA/SDI production readiness ora in Phase 2C | IMPORTANTE per go-live IT |
...
3. Phase 2C: FatturaPA/SDI production readiness (schema, mapping, XML/XSD, provider, permessi).
...
Priorità: **Phase 2A** e **2B** sono completate; la priorità corrente è **2C (FatturaPA/SDI)**, poi Phase 3+ (API azioni dominio, architettura).
