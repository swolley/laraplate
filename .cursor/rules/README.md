...
- `09-database-guidelines.mdc` database migrations, queries, indexes, multi-DB compatibility, and connection affinity across multiple configured connections (MySQL, MariaDB, PostgreSQL, Oracle, SQLite).
