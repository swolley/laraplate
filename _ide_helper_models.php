 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Approval query()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Approval whereApproverId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Approval whereApproverType($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Approval whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Approval whereId($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob lockedBy(\Modules\Core\App\Models\User $user)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob onlyTrashed()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob query()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob unlocked()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob unlockedBy(\Modules\Core\App\Models\User $user)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob whereCommand($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\CronJob whereDescription($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Disapproval query()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Disapproval whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Disapproval whereDisapproverId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Disapproval whereDisapproverType($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Disapproval whereId($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\License occupied()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\License query()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\License validAt(\Illuminate\Support\Carbon $date)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\License whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\License whereId($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereApproversRequired($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereDisapproversRequired($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereIsUpdate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereMd5($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereModifiableId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereModifiableType($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Modification whereModifications($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Permission whereDescription($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Permission whereGuardName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Permission whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Permission whereName($value)
 ...
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role breadthFirst()
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role depthFirst()
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role doesntHaveChildren()
 * @method static \Modules\Core\Database\Factories\RoleFactory factory($count = null, $state = [])
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Collection<int, static> get($columns = ['*'])
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role getExpressionGrammar()
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role hasChildren()
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role hasParent()
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role isLeaf()
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role isRoot()
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role locked()
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role lockedBy(\Modules\Core\App\Models\User $user)
 ...
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role unlocked()
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role unlockedBy(\Modules\Core\App\Models\User $user)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereCreatedAt($value)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereDeletedAt($value)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereDepth($operator, $value = null)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereDescription($value)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereGuardName($value)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereId($value)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereLockedAt($value)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereLockedUserId($value)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereName($value)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereParentId($value)
 * @method static \Staudenmeir\LaravelAdjacencyList\Eloquent\Builder|\Modules\Core\App\Models\Role whereUpdatedAt($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting onlyTrashed()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting query()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereChoices($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereDescription($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereEncrypted($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereGroupName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereType($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\Setting whereUpdatedAt($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User lockedBy(\Modules\Core\App\Models\User $user)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User onlyTrashed()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User permission($permissions, $without = false)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User query()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User role($roles, $guard = null, $without = false)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User unlocked()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User unlockedBy(\Modules\Core\App\Models\User $user)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereEmail($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereEmailVerifiedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereLang($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereLastLoginAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereLicenseId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereLockedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereLockedUserId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User wherePassword($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereRememberToken($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereTwoFactorConfirmedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereTwoFactorRecoveryCodes($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereTwoFactorSecret($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User whereUsername($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\User withTrashed()
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\UserGridConfig query()
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\UserGridConfig whereConfig($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\UserGridConfig whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\UserGridConfig whereGridName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\UserGridConfig whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Core\App\Models\UserGridConfig whereIsPublic($value)
