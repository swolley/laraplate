...
- `2026-06-30-erp-hardening-spec2-filament-domain-actions-design.md`: ERP Spec 2 master backlog — mandatory non-API work completed; API governance deferred; module import framework planned for `4-09`.
