...
| `docs/.gitkeep` | Module documentation home |
...
- Produces: `ScaffoldingComplianceTest`, extended in Task 4 with the tooling files. Task 4 edits its dataset rather than adding a second test file.
...
Expected: PASS, 17 tests — 13 dataset cases plus the 4 named assertions (licence and readme from Task 3, Pint and PHPUnit from Task 4).
